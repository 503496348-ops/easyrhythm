...
triage_agent = Agent[AirlineAgentChatContext](
    ...
    instructions=(
        ...
        "IMPORTANT: Before routing, check the context for pre-classified intent data (last_intent, last_intent_confidence) "
        "and extracted entities. Use this information to make faster, more accurate routing decisions. "
        "If intent is already classified with high confidence, trust it and route accordingly. "
        "If entities like flight_number or confirmation_number are already extracted, skip asking for them. "
